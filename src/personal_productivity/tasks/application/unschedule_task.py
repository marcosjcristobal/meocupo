"""Application use case for unscheduling one task."""
...
# Task contains the authoritative unscheduling operation.
from personal_productivity.tasks.domain.task import Task


@dataclass(slots=True, kw_only=True)
class UnscheduleTask:
    """Clear one task allocation and persist its newer planning state."""
    ...
    def execute(
        ...
        *,
        ...
        """Remove the task's current calendar allocation."""
        ...
        # Delegate editability rules to the domain entity.
        task.unschedule()
